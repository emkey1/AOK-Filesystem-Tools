...
[ -f /etc/init.d/hostname ] && rsync_chown "$aok_content"/common_AOK/hostname_handling/aok-hostname-service /etc/init.d/hostname
[ -f /usr/local/bin/hostname ] && rsync_chown "$aok_content"/common_AOK/hostname_handling/hostname_alt /usr/local/bin/hostname
[ -f /usr/local/sbin/hostname_sync.sh ] && rsync_chown "$aok_content"/common_AOK/hostname_handling/hostname_sync.sh /usr/local/sbin
echo
